...
<!-- On a bench. Starts locked out; lowers under control.
...
<template>
  <svg viewBox="0 0 200 200" role="img" class="fig" :class="{ 'is-paused': paused }">
    <title>Flat dumbbell bench press</title>
    ...
    <path class="arrow" d="M150 104 L150 130 M145 124 L150 131 L155 124" aria-hidden="true" />
    ...
    <g class="body">
      ...
      <g class="upperarm">
        ...
        <g class="forearm">
          ...
          <rect class="load" x="87" y="88" width="16" height="10" rx="5" />
        </g>
      </g>
    </g>
  </svg>
