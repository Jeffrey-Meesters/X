...
<!-- Two dumbbells pressed hard together throughout.
...
<template>
  <svg viewBox="0 0 200 200" role="img" class="fig" :class="{ 'is-paused': paused }">
    <title>Dumbbell squeeze press</title>
    ...
    <path class="arrow" d="M150 104 L150 128 M145 122 L150 129 L155 122" aria-hidden="true" />
      <rect class="prop" x="46" y="150" width="112" height="8" rx="3" />
    <g class="body">
      <circle class="head" cx="58" cy="140" r="11" />
      <line x1="69" y1="146" x2="126" y2="146" />
      <line x1="126" y1="146" x2="142" y2="166" />
      <line x1="142" y1="166" x2="136" y2="183" />
      <circle class="joint" cx="92" cy="146" r="4" />
      <g class="upperarm">
        <line x1="95" y1="146" x2="95" y2="118" />
        <circle class="joint" cx="95" cy="118" r="4" />
        <g class="forearm">
          <line x1="95" y1="118" x2="95" y2="96" />
          <rect class="load" x="88" y="86" width="7" height="12" rx="3" />
          <rect class="load" x="96" y="86" width="7" height="12" rx="3" />
        </g>
      </g>
    </g>
  </svg>
