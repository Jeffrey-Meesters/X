...
<!-- One arm braced, the other rows. Shoulders stay square.
...
<template>
  <svg viewBox="0 0 200 200" role="img" class="fig" :class="{ 'is-paused': paused }">
    <title>Single-arm dumbbell row</title>
    ...
    <g class="shin">
      ...
      <g class="thigh">
        ...
        <g class="torso">
          ...
          <line class="prop" x1="100" y1="86" x2="132" y2="104" />
          <g class="arm">
            <line x1="100" y1="80" x2="100" y2="116" />
            <rect class="load" x="92" y="114" width="16" height="10" rx="5" />
          </g>
        </g>
      </g>
    </g>
