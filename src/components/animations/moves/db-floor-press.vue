...
<!-- On the floor, which limits the range at the bottom.
...
<template>
  <svg viewBox="0 0 200 200" role="img" class="fig" :class="{ 'is-paused': paused }">
    <title>Dumbbell floor press</title>
    ...
    <path class="arrow" d="M150 130 L150 152 M145 146 L150 153 L155 146" aria-hidden="true" />
    <g class="body">
      ...
      <g class="upperarm">
        <line x1="95" y1="172" x2="95" y2="146" />
        <circle class="joint" cx="95" cy="146" r="4" />
        <g class="forearm">
          <line x1="95" y1="146" x2="95" y2="124" />
          <rect class="load" x="87" y="116" width="16" height="10" rx="5" />
        </g>
      </g>
    </g>
  </svg>
